function HTMLActuator() {
  ...
  dogeSayings = ['PIIEENET Huudot', 'Lisää kimitystä!', 'Lisää huutoa!', 'Jälkkää tuli', 'Jussiiih', '', 'Ui helvetti Jari on tuolla', 'Jariiih', 'Jussi mee salille', 'Riston kulli']
  ...
  HTMLActuator.prototype.message = function (won) {
    ...
    var message = won ? "Perkele jäit" : "Game over!";
